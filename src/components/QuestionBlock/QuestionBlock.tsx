...
function QuestionBlock({ question }: QuestionBlockProps) {
  return (
    <Link to={"/"} className="question-block">
      ...
      <div className="question-block-info">
        ...
        <div className="question-block-info-stats">
          <div className="question-block-info-stats-detail">
            <span className="question-block-info-stats-detail-icon">
              <FaRegEye />
            </span>
            {question.viewCount}
          </div>
